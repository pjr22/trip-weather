...
window.TripWeather.App = {
    ...
    initializeManagers: function() {
        ...
        const requiredManagers = ['Map', 'Waypoint', 'WaypointRenderer', 'Search', 'UI', 'AuthModals', 'Route', 'Layer', 'EVChargingStation', 'FavoritesManagerModal', 'MyRoutesModal', 'Navigation', 'Export'];
